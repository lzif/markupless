...
describe('Style System', () => {
  ...
  describe('StyleManager', () => {
    it('should create a style element in the head', () => {
      ...
      styleElement = document.getElementById('markupless-styles') as HTMLStyleElement;
    ...
    it('should generate a unique class name and inject CSS', () => {
      ...
      styleElement = document.getElementById('markupless-styles') as HTMLStyleElement;
      expect(styleElement.textContent).toContain(`.${className} {color: blue;font-size: 20px;}`);
    });
    ...
    it('should handle nested styles (pseudo-classes)', () => {
      ...
      expect(styleElement.textContent).toContain(`.${className} {color: green;}`);
      expect(styleElement.textContent).toContain(`.${className}:hover {color: red;}`);
    });
     ...
     it('should handle media queries', () => {
      ...
      styleElement = document.getElementById('markupless-styles') as HTMLStyleElement;
      expect(styleElement.textContent).toContain(`@media (min-width: 500px) { .${className} {color: purple;} }`);
    });
  });
  ...
  describe('Theme System', () => {
    it('should generate CSS variables and return variable references', () => {
        ...
        expect((theme.colors.secondary as any).light).toBe('var(--colors-secondary-light)');
